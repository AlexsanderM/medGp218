...
public class Const {
    ...
    public final static String SEARCH_SERVIVES_PROV_DISP = "SELECT idServices, dateService, address ,diagnoz, serPolis, service, kratnost, fioDocter, attach, fioPathient, sex, dataBirday  FROM " + Const.SERVICESTABLE + " WHERE " + Const.SERVICE_DATE + " >='2019-01-01' AND " + Const.SERVICE_DATE + "<? " +
            "and ((service >= 1900 and service <= 1920) or service = 15001 or (service >= 35211 and service <= 35408) or " +
            "service = 1441 or service = 2012 or service = 2013 or service = 25063 or service = 25064 or service = 25065 or service = 25204 or service = 101101)";
    public final static String SEARCH_SERVIVES_AFTER = "SELECT idServices, dateService, address ,diagnoz, serPolis, service, kratnost, fioDocter, attach, fioPathient, sex, dataBirday  FROM " + Const.SERVICESTABLE + " WHERE " + Const.SERVICE_DATE + " >=?";
